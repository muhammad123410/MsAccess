...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('full_authorities.store')); ?>" method="post" class="mt-4">
        ...
        <div class="row m-2">
            ...
            <input type="text" name="Client_id" id="" class="form-control col-sm-9" value="<?php echo e($Client->Client_id); ?>">
        </div>
        

        <div class="row m-2">
            <label for="" class="font-weight-bold col-sm-3">Auth Id:</label> 
            <input type="text" name="Auth_Id" id="" class="form-control col-sm-9">
        </div>
